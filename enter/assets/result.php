<?php
  ...
  $query="SELECT * FROM 2022_results WHERE number='$number' OR position='$position'";
  $result=$conn->query($query);
  if($result->num_rows==0) {
    $query="INSERT INTO 2022_results (position,number,minutes,seconds) VALUES ('$position','$number','$minutes','$seconds')";
    $conn->query($query);
